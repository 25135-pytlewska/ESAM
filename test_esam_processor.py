...
def test_extract_reg_number(processor):
    assert processor.extract_reg_number("Nr rej. ABC123") == "ABC123"
...
def test_process_registration_numbers(processor, sample_df):
    ...
    assert processed['reg_number'].iloc[0] == 'ABC123'
...
def test_process_dates(processor, sample_df):
    ...
    assert processed.loc[1, 'date'] == '2024-09-01'
...
def test_process_values(processor, sample_df):
    ...
    assert processed.loc[2, 'mpal'] == '10.5'
    assert processed.loc[2, 'stops'] == '2'
